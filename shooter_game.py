...
# фонова музика
mixer.init()
mixer.music.load('BOUHA.ogg')
mixer.music.play()
fire_sound = mixer.Sound('HELLO.ogg')
 
# нам потрібні такі картинки:
img_back = "moskva.jpg"  # фон гри
img_hero = "thela.jpg"  # герой
img_bullet = "haumars.jpg" # куля
img_enemy = "pyt.png"  # ворог
img_ast = "lyk.jpg" # астероїд


score = 0  # збито кораблів
goal = 50 # стільки кораблів потрібно збити для перемоги
lost = 0  # пропущено кораблів
max_lost = 10 # програли, якщо пропустили стільки
life = 3  # очки життя
